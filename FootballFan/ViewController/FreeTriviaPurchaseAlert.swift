...
import Foundation
import UIKit
class FreeTriviaPurchaseAlert: UIViewController {
   ...
   // var triviaTypeString: String?
    ...
    var triviaprice: Double?
     @IBOutlet weak var viewTremsConstraint2: NSLayoutConstraint!
    static func instantiate() -> FreeTriviaPurchaseAlert? {
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "FreeTriviaPurchaseAlert") as? FreeTriviaPurchaseAlert
    }
