...
public class PopupViewController: UIViewController {
    ...
    private func addDismissGesture() {
       /* let tapGesture = UITapGestureRecognizer(target: self, action: #selector(dismissTapGesture(gesture:)))
        ...
        let swipeRight = UISwipeGestureRecognizer(target: self, action: #selector(dismissTapGesture(gesture:)))
        swipeRight.direction = UISwipeGestureRecognizer.Direction.up
        self.view.addGestureRecognizer(swipeRight)
        
        let swipeDown = UISwipeGestureRecognizer(target: self, action: #selector(dismissTapGesture(gesture:)))
    ...
    func appDelegate() -> AppDelegate {
        ...
        DispatchQueue.main.async{
            PopupViewController.realDelegate = UIApplication.shared.delegate as? AppDelegate;
            dg.leave();
        }
        dg.wait();
        return PopupViewController.realDelegate!;
    }
}
