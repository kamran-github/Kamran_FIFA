...
import UIKit
import Alamofire
class FollowingViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate{
   ...
   // var activityIndicator: UIActivityIndicatorView?
    ...
    @objc func getfollowers(_ lastindex : Int)
    {
       ...
       var dictRequest = [String: AnyObject]()
                                dictRequest["cmd"] = "getfollowings" as AnyObject
