...
import UIKit
import Alamofire
class LikeViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate{
...
var isFanPageLikeRefresh: Bool = false
    ...
    @objc func FanUpdateGetLikes(_ lastindex : Int)
    {
       ...
       var dictRequest = [String: AnyObject]()
                                dictRequest["cmd"] = "getupdatelikes" as AnyObject
                                                                                                                                                 ...
                                                                                                                                                 if(status1){
                                                                                                                                                     ...
                                                                                                                                                     let response: NSArray = json["responseData"] as! NSArray
                                                                                                                                                         ...
                                                                                                                                                         if(self.isFanPageLikeRefresh)
                                                                                                                                                                                                    {
                                                                                                                                                                                                     self.appDelegate().arrFanUpdateLikes = response  as [AnyObject]
                                                                                                                                                                                                    }
                                                                                                                                                                                                    else
                                                                                                                                                                                                    {
                                                                                                                                                                                                     self.appDelegate().arrFanUpdateLikes += response  as [AnyObject]
                                                                                                                                                        ...
                                                                                                                                                        DispatchQueue.main.async
                                                                                                                                                            {
                                                                                                                                                             if(self.isFanPageLikeRefresh)
                                                                                                                                                                                                                   {
                                                                                                                                                                                                                     self.appDelegate().arrFanUpdateLikes = [AnyObject]()
    ...
    @objc func refreshFanUpdateGetLikes()
    {
        ...
        //TransperentLoadingIndicatorView.hide()
        closeRefresh()
        if(self.appDelegate().arrFanUpdateLikes.count == 0){
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if(appDelegate().arrFanUpdateLikes.count > 19)
        {
        let lastElement = appDelegate().arrFanUpdateLikes.count - 1
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return self.appDelegate().arrFanUpdateLikes.count
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dic: NSDictionary? = self.appDelegate().arrFanUpdateLikes[indexPath.row] as? NSDictionary
        //print(dic)
    ...
    func updatecommentOnArrays(){
           ...
           if(self.appDelegate().temparrMyFanUpdatesTeams.count>0) {
               for i in 0...self.appDelegate().temparrMyFanUpdatesTeams.count-1 {
                   let dict: NSDictionary? = self.appDelegate().temparrMyFanUpdatesTeams[i] as? NSDictionary
                          if(dict != nil)
                          {
                           let GroupID = dict?.value(forKey: "id") as! Int64
                           if(fanupdateid == GroupID){
                               var dict1: [String: AnyObject] = self.appDelegate().temparrMyFanUpdatesTeams[i] as! [String: AnyObject]
                                dict1["likecount"] = likecount as AnyObject
                               dict1["commentcount"] = commentcount as AnyObject
                               dict1["viewcount"] = viewcount as AnyObject
                               self.appDelegate().temparrMyFanUpdatesTeams[i] = dict1 as AnyObject
