...
public struct AHCategoryNavBarStyle {
    ...
    public var indicatorHeight:CGFloat = 4.0
    public var indicatorColor:UIColor = UIColor.init(hex: "FFD401")//UIColor(red: 244.0/255.0, green: 173.0/255.0, blue: 98.0/255.0, alpha: 1.0)
