...
class ShowFreedomview:UIView {
    ...
    static func show(_ overlayTarget : UIView, loadingText: String?, fancoins: String?) {
      ...
      /*  NotificationCenter.default.addObserver(
            self, selector:
            #selector(ShowFreedomview.rotated),
        ...
        */
        ...
        gryview.frame.size.height = 250//CGFloat(400.0)
        ...
        label.frame.size.width = gryview.frame.width - 10
         label.frame.size.height = gryview.frame.width - 10
        label.sizeToFit()
         label.center = CGPoint(x: gryview.frame.width/2, y: gryview.frame.height/2)
     ...
     /*   if((label.frame.height) > 15)
        {
            let height = (label.frame.height) + 20.0
        ...
        /*let coinview = UIView()
        coinview.frame.size.width = 50.0
        coinview.frame.size.height = 50.0
        ...
        imageViewTeam.frame = CGRect(x: 0, y: 50, width: 50.0, height: 50.0)
