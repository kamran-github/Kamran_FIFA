...
//  FootballFan
//
//  Created by Mayank Sharma on 04/06/18.
...
open class GrowingTextView: UITextView {
    ...
    private weak var heightConstraint1: NSLayoutConstraint?
    ...
    func appDelegate() -> AppDelegate {
        ...
        DispatchQueue.main.async{
            GrowingTextView.realDelegate = UIApplication.shared.delegate as? AppDelegate;
            dg.leave();
        }
        dg.wait();
        return GrowingTextView.realDelegate!;
    }
    ...
    override open func layoutSubviews() {
        ...
        if height != heightConstraint1!.constant {
            ...
            if(appDelegate().isOnChatView == true){
                let actionUserinfo:[String: AnyObject] = ["hight": height as AnyObject]
                
                let notificationName = Notification.Name("texthightchange")
