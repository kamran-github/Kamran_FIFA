...
import UIKit
import AVFoundation
class AnimationIndicatorView:UIView {
    ...
    static func show(_ overlayTarget : UIView, loadingText: String?, fancoins: String?) {
      ...
      /*  NotificationCenter.default.addObserver(
            self, selector:
            #selector(AnimationIndicatorView.rotated),
        ...
        label.sizeToFit()
        label.center = CGPoint(x: gryview.frame.width/2, y: 160)//y:155
       ...
       // label.backgroundColor = UIColor.green
        ...
        {
            let height = (label.frame.height) + 130.0
        ...
        imageViewTeam.frame = CGRect(x: 0, y: 60, width: 60.0, height: 60.0)
        ...
        let lblforward = UILabel(frame: CGRect(x: gryview.center.x-140, y: 10.0, width: 300, height: 50.0))//changed
        // lblforward.font = UIFont.systemFont(ofSize: 30)
        lblforward.font = UIFont.boldSystemFont(ofSize: 25)
        lblforward.text = "Congratulations!!"
       ...
       // lblforward.backgroundColor = UIColor.red
      ...
      /*  let path = Bundle.main.path(forResource: "won.mp3", ofType:nil)!
        ...
        do {
         ...
         let url = Bundle.main.url(forResource: "won", withExtension: "mp3")!
         print("audio URL\(url)")
        do {
            ...
            let url2 = Bundle.main.url(forResource: "won", withExtension: "mp3")!
            ...
            currentgryview?.layer.addSublayer(playerLayer)
        ...
        /*if let audioFileURL =  Bundle.main.url(forResource: "won", withExtension: "mp3"){
            print("audio URL\(Bundle.main.url(forResource: "won", withExtension: "mp3", subdirectory: "Extra") )")
            do {
